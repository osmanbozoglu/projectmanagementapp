...
import io.bozoglu.projectmanagementapp.services.ProjectTaskService;
...
public class BacklogController {
    ...
    public ResponseEntity<?> addPTtoBacklog(@Valid @RequestBody ProjectTask projectTask,
        ...
        ProjectTask projectTaskGenerated = projectTaskService.addProjectTask(backlog_id, projectTask);

        return new ResponseEntity<ProjectTask>(projectTaskGenerated, HttpStatus.CREATED);
    }
